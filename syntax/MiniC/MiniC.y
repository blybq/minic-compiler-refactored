...
%token IF ELSE INT RETURN VOID WHILE IDENTIFIER
...
param
	...
	| type_spec IDENTIFIER LBRACKET CONSTANT RBRACKET { $$ = newNode('param', $1, $2, $4); }
	;
...
if_stmt
	...
	| IF LPAREN expr RPAREN stmt ELSE stmt { $$ = newNode('if_stmt', $3, $5, $7); }
	;
